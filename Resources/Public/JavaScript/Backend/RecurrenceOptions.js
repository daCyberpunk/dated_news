...
/*
 * show/hide fields/tabs according to choosen
 * recurrence options in an event in backend
 *
 * */
define(['jquery',
    ...
    RecurrenceOptions.init = function() {
        //todo rewrite all with correct implementation of TYPO3 Classes
        var d = document,
