...
//$GLOBALS['TYPO3_CONF_VARS']['EXT']['news']['classes']['Controller/NewsController'][] = 'dated_news'; //commented out, otherwise class will be cached and detailaction cannot be redeclared
